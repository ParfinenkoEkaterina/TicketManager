...
public class TicketManagerTest {
    ...
    @Test
    public void testFindsOneRouteTickets() {
        TicketRepository repo = new TicketRepository();
        TicketManager manager = new TicketManager(repo);
    ...
    public void testNotFindsPriceTicket() {
        ...
        Ticket[] expected = {};
        Ticket[] actual = manager.findAll("Paris", "Moskow", new TicketByPriceAscComparator());

        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void testNotFindsPriceTicketEqual() {
        TicketRepository repo = new TicketRepository();
        TicketManager manager = new TicketManager(repo);

        Ticket ticket1 = new Ticket(1, "Moskow", "Paris", 500, 188);
        Ticket ticket2 = new Ticket(2, "Moskow", "Paris", 500, 190);
        Ticket ticket3 = new Ticket(3, "Moskow", "Paris", 200, 189);
        Ticket ticket4 = new Ticket(4, "Minsk", "Sochi", 220, 160);
        Ticket ticket5 = new Ticket(5, "Moskow", "Paris", 400, 192);
        Ticket ticket6 = new Ticket(6, "Moskow", "Paris", 440, 191);
        Ticket ticket7 = new Ticket(7, "SPB", "Murmansk", 300, 56);
        Ticket ticket8 = new Ticket(8, "Murmansk", "SPB", 202, 58);
    ...
    public void testFindsSortOfId() {
        ...
        Ticket[] actual = manager.findAll("Moskow", "Paris", new TicketByIdAscComparator());

        Assertions.assertArrayEquals(expected, actual);
    }

    @Test
    public void testNotFindsIdTicket() {
        TicketRepository repo = new TicketRepository();
        TicketManager manager = new TicketManager(repo);
        ...
        Ticket[] expected = {};
        Ticket[] actual = manager.findAll("Paris", "Moskow", new TicketByIdAscComparator());
